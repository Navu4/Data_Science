...
def predict():
    ...
    Item_Visibility = float(request.form['Visibility (Range 0.003575 - 0.328391)'])
    ...
    # return render_template('home.html',prediction = output,Item_Identifier = Item_Identifier, Outlet_Identifier = Outlet_ID)
    return render_template('home.html', prediction_text='The Sales production of {} by {} is<br> {}  price'.format(Item_Identifier,Outlet_ID,output))
